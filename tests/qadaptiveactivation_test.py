...
def run_qadaptiveactivation_test(input_val, kwargs):
    ...
    err = f"Failed test with {kwargs} on input {input_val}"
...
def test_qadaptiveact_ema(momentum, ema_freeze_delay, total_steps, estimate_step_count):
    ...
    for i in range(0, total_steps):
        ...
        exp_int_bits = _get_integer_bits(
            exp_ema_min,
            exp_ema_max,
