...
class ConfigClass:
    ...
    def update(self, process, cfg_setting):
        ...
        try:
            self.default_source_quantizer = cfg_setting["default_source_quantizer"]
        except:
            pass

        try:
            self.default_interm_quantizer = cfg_setting["default_interm_quantizer"]
        except:
            pass
