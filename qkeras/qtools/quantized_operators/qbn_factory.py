...
class QBNFactory:
    ...
    def make_quantizer(
        ...
        if use_scale:
            # gamma/var
            divider = divider_instance.make_quantizer(gamma_quantizer, stddev_quantizer)
            ...
            if gamma_quantizer.is_po2 and gamma_quantizer.inference_value_counts > 0:
                ...
                if (
                    stddev_quantizer.is_po2
                    and stddev_quantizer.inference_value_counts > 0
                ):
            ...
            # x/var
            divider = divider_instance.make_quantizer(input_quantizer, stddev_quantizer)
