...
class IAdder(abc.ABC):
    ...
    def make_quantizer(
        self,
        quantizer_1: quantizer_impl.IQuantizer,
        ...
        logging.debug(
            "qbn adder implemented as class %s", adder_impl_class.implemented_as()
        )

        return adder_impl_class(local_quantizer_1, local_quantizer_2)
