...
class MultiplierFactory:
    ...
    def __init__(self):
        ...
        self.multiplier_impl_table = [
            [
                (multiplier_impl.FixedPointMultiplier, quantizer_impl.QuantizedBits()),
    ...
    def make_multiplier(
        ...
        (multiplier_impl_class, output_quantizer) = self.multiplier_impl_table[
            weight_quantizer.mode
        ][input_quantizer.mode]
        ...
        logging.debug(
            "multiplier implemented as class %s", multiplier_impl_class.implemented_as()
        )

        assert issubclass(multiplier_impl_class, multiplier_impl.IMultiplier)

        return multiplier_impl_class(
            local_weight_quantizer, local_input_quantizer, local_output_quantizer
        )
